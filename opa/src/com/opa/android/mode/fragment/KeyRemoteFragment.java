...
import com.opa.android.mode.utils.BroadcastUtils;
...
public class KeyRemoteFragment extends BaseFragment {
	...
	@Click
	public void gpsImg(){
		com.opa.android.mode.activity.CloudSmartControlActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK).start();
	}
	@Click
	public void stopImg(){
		if(!app.ble.isSmartBikeAvailable()){
	...
	public void checkImg(){
		com.opa.android.mode.activity.CarCheckActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK).start();
	}
	@Click
...
//            app.ble.disConnectDevice();
			com.opa.android.mode.activity.ScanActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK).start();
