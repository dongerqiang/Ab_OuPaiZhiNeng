...
public final class KeyRemoteFragment_
    extends com.opa.android.mode.fragment.KeyRemoteFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        loakImg = ((ImageView) hasViews.findViewById(com.opa.android.R.id.loakImg));
        stopImg = ((ImageView) hasViews.findViewById(com.opa.android.R.id.stopImg));
        {
            View view = hasViews.findViewById(com.opa.android.R.id.gpsImg);
            if (view!= null) {
        ...
        {
            View view = hasViews.findViewById(com.opa.android.R.id.carImg);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(com.opa.android.R.id.checkImg);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(com.opa.android.R.id.locationImg);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(com.opa.android.R.id.blueImg);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<KeyRemoteFragment_.FragmentBuilder_, com.opa.android.mode.fragment.KeyRemoteFragment>
    {


        @Override
        public com.opa.android.mode.fragment.KeyRemoteFragment build() {
