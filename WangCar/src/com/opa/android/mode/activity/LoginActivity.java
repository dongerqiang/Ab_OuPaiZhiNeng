...
import com.opa.android.mode.utils.KeyBoardUtils;
import com.opa.android.mode.utils.ToastUtils;
...
public class LoginActivity extends BaseActivity implements OnClickListener {
    ...
    private void goLogin() {
    	com.opa.android.MainActivity_.intent(LoginActivity.this).start();
...
//                ToastUtils.showShort(mContext,"暂时不支持注册");
                com.opa.android.mode.activity.RegisteActivity_.intent(LoginActivity.this).start();
                break;
        }
    }
