package com.opa.android.mode.ble;

import java.util.ArrayList;
import java.util.List;

import com.opa.android.MainActivity;
import com.opa.android.MyApplication;
import com.opa.android.mode.activity.DeviceDB;
import com.opa.android.mode.interfaces.IBlueCallback;
import com.opa.android.mode.utils.BroadcastUtils;
import com.opa.android.mode.utils.ParserData;
...
public class BleInterface {
	...
	public  void startSmartBikeService(Context context){		
		...
		nb.setSmallIcon(com.opa.android.R.drawable.ic_launcher);
		nb.setTicker("欧派智能");
		nb.setContentTitle("欧派智能");
