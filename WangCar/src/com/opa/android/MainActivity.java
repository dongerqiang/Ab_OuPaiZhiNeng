...
import com.opa.android.mode.ble.BleInterface;
import com.opa.android.mode.fragment.KeyRemoteFragment;
import com.opa.android.mode.fragment.MoreFragment;
import com.opa.android.mode.fragment.YiBiaoFragment;
import com.opa.android.R;
import com.opa.android.R.drawable;
...
//		MyApplication.app.setSystemBar(this);
		...
		keyRemoteFragment = com.opa.android.mode.fragment.KeyRemoteFragment_.builder().build();
		yiBiaoFragment = com.opa.android.mode.fragment.YiBiaoFragment_.builder().build();
		moreFragment = com.opa.android.mode.fragment.MoreFragment_.builder().build();
