...
/*  28 */     this.mAccountManageChannel = new BluxVirtualDevice.PacketChannel(REG_DEVICE0_USER_MANAGEMENT);
/*  29 */     this.mAuthChannel = new BluxVirtualDevice.PacketChannel(REG_DEVICE0_AUTH);
/*  30 */     service.vdDelegate = new VDServiceDelegate();
/*     */ 
