...
/*  17 */     this.mBlueGuardDelegate = new BlueGuardDelegate();
...
/* 227 */       byte[] data1 = cmd.getData().getByteArray("data");
/*     */       try {
/* 229 */         UUID idDevice = UUID.fromString(sDevice);
/* 230 */         if (data1 != null) {
/* 231 */           this.mBlueGuard.writeVirtualDevice(idDevice, register, data1);
/*     */         }
/*     */       }
