...
/* 222 */       String str1 = String.format("%06d", new Object[] { Integer.valueOf(key) });
/* 223 */       this.delegate.updatePairPasskey(str1);
/* 224 */       break;
/*     */     case 52:
...
/* 248 */       short offset1 = le2s(data, 0);
/* 249 */       byte[] d1 = Arrays.copyOfRange(data, 2, data.length);
/* 250 */       this.delegate.updatePrivateNvm(offset1, d1);
/* 251 */       break;
/*     */     case 20:
/*     */     case 21:
/*     */     case 22:
